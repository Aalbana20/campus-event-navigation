...
export const sanitizePhoneNumber = (value) => value.replace(/[^\d+]/g, "")
...
export const buildProfileSummary = ({ accountType, firstName, organizationName, interests }) => {
  ...
  return firstName ? `${firstName} is exploring campus events.` : "Exploring campus events and new people."
}
